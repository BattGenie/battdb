alter table sil_data drop constraint sil_data_pkey;

SELECT create_hypertable('sil_data', 'insert_time',  chunk_time_interval => INTERVAL '1 day', migrate_data => TRUE, if_not_exists => TRUE);
