...
-- Change the data type of the capacity and energy columns
ALTER TABLE hil_data ALTER COLUMN reported_charge_capacity_mah TYPE SMALLINT;
ALTER TABLE hil_data ALTER COLUMN reported_discharge_capacity_mah TYPE SMALLINT;
ALTER TABLE hil_data ALTER COLUMN reported_charge_energy_mwh TYPE SMALLINT;
ALTER TABLE hil_data ALTER COLUMN reported_discharge_energy_mwh TYPE SMALLINT;
