-- Add capacity and energy to hil_data
ALTER TABLE hil_data
ADD COLUMN reported_charge_capacity_mah numeric;
ALTER TABLE hil_data
ADD COLUMN reported_discharge_capacity_mah numeric;
ALTER TABLE hil_data
ADD COLUMN reported_charge_energy_mwh numeric;
ALTER TABLE hil_data
ADD COLUMN reported_discharge_energy_mwh numeric;
